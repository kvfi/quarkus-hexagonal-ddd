package com.acme.domain.shared;
...
public abstract class RootAggregate {
  ...
  /**
   * Called by the persistence framework to clear all registered domain events once they have been
   * published.
   */
  ...
  /**
   * Returns all domain events that have been registered for publication. Intended to be used by the
   * persistence framework only.
   */
